...
class Game
  ...
  def Game.check_for_winner
    puts "#{Board.cells[0].symbol}"
    #check rows
    Game.set_winner(Board.cells[0].symbol) if (@@cells[0].symbol != Constants::EMPTY_CELL && @@cells[0].symbol ==  @@cells[1].symbol && @@cells[0].symbol == @@cells[2].symbol)
    Game.set_winner(Board.cells[0].symbol) if (@@cells[3].symbol != Constants::EMPTY_CELL && @@cells[3].symbol ==  @@cells[4].symbol && @@cells[0].symbol == @@cells[5].symbol)
    Game.set_winner(Board.cells[0].symbol) if (@@cells[6].symbol != Constants::EMPTY_CELL && @@cells[6].symbol ==  @@cells[7].symbol && @@cells[0].symbol == @@cells[8].symbol)
    #check columns
