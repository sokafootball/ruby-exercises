...
class Game
  ...
  def Game.check_for_winner
    ...
    Game.set_winner(Board.cells[0].symbol) if (Board.cells[3].symbol != Constants::EMPTY_CELL && Board.cells[3].symbol ==  Board.cells[4].symbol && Board.cells[0].symbol == Board.cells[5].symbol)
    Game.set_winner(Board.cells[0].symbol) if (Board.cells[6].symbol != Constants::EMPTY_CELL && Board.cells[6].symbol ==  Board.cells[7].symbol && Board.cells[0].symbol == Board.cells[8].symbol)
    #check columns
    ...
    Game.set_winner(Board.cells[1].symbol) if (Board.cells[1].symbol != Constants::EMPTY_CELL && Board.cells[1].symbol ==  Board.cells[4].symbol && Board.cells[0].symbol == Board.cells[7].symbol)
    Game.set_winner(Board.cells[2].symbol) if (Board.cells[2].symbol != Constants::EMPTY_CELL && Board.cells[2].symbol ==  Board.cells[5].symbol && Board.cells[0].symbol == Board.cells[8].symbol)
    #check diagonalsBoard.
