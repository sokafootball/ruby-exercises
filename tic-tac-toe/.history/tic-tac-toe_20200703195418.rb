...
class Game
  ...
  def Game.run_computer_turn
    ...
    loop do
      @chosen_cell = rand(9)
      break if Board.cells[@chosen_cell].symbol == " "
    end
  ...
  def Game.check_for_winner
    #check rows
    return Game.set_winner(@@cells[0].symbol) if (@@cells[0].symbol != Constants::EMPTY_CELL && @@cells[0].symbol ==  @@cells[1].symbol && @@cells[0].symbol == @@cells[2].symbol)
    @@winning_symbol = @@cells[3].symbol if (@@cells[3].symbol != Constants::EMPTY_CELL && @@cells[3].symbol ==  @@cells[4].symbol && @@cells[0].symbol == @@cells[5].symbol)
    @@winning_symbol = @@cells[6].symbol if (@@cells[6].symbol != Constants::EMPTY_CELL && @@cells[6].symbol ==  @@cells[7].symbol && @@cells[0].symbol == @@cells[8].symbol)
  end
