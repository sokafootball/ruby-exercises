...
class Board
  ...
  def Board.check_for_winner
    @@winning_symbol
    #check rows
    @@winning_symbol = @@cells[0].symbol if (@@cells[0].symbol != Constants::EMPTY_CELL @@cells[0].symbol ==  @@cells[1].symbol && @@cells[0].symbol == @@cells[2].symbol)
  end
